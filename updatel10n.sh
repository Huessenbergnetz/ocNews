...
lupdate-qt5 -pluralonly -source-language en -target-language $LANG -locations relative -no-obsolete reader/common reader/sailfishos -ts reader/sailfishos/l10n/ocnewsreader_$LANG.ts
...
lupdate-qt5 -source-language en -locations relative -no-obsolete reader/common reader/sailfishos -ts reader/sailfishos/l10n/ocnewsreader.ts
